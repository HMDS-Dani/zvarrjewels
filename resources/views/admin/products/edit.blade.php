...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="glass-card-luxury p-4 sm:p-8 rounded-3xl space-y-6">
        <div class="mb-4 sm:mb-6 pb-4 sm:pb-6 border-b border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div>
                <h2 class="font-cinzel font-bold text-base sm:text-xl text-white">Edit: {{ $product->name }}</h2>
                <p class="text-xs text-stone-400 mt-0.5 sm:mt-1">Update specifications, AI description, and photos for this item.</p>
            </div>
        ...
        <form id="product-form" action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="space-y-5 sm:space-y-6">
            ...
            <!-- Hidden input for client-side processed transparent/adjusted PNG -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                    ...
                    <input type="text" name="name" id="product_name_input" value="{{ old('name', $product->name) }}" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div>
                    ...
                    <input type="text" name="material" id="product_material_input" value="{{ old('material', $product->material) }}" required
                        class="w-full px-4 py-3 bg-[#0a0a10] border border-white/10 rounded-2xl text-xs sm:text-sm text-white focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition">
                </div>
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    <textarea name="description" id="product_description_input" rows="3"
                        ...
                        class="w-full px-4 py-3 bg-[#0a0a10] border border-white/10 rounded-2xl text-xs sm:text-sm text-white focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition resize-none leading-relaxed">{{ old('description', $product->description) }}</textarea>
            ...
            <div class="p-4 sm:p-6 rounded-3xl bg-[#08080d] border border-amber-400/15 space-y-4 sm:space-y-5">
                ...
                <div id="preview-wrapper" class="{{ $product->image ? '' : 'hidden' }} pt-4 border-t border-slate-800/80 space-y-3">
                    ...
                    <div id="card-preview-podium" class="flex items-center justify-center p-4 sm:p-6 rounded-2xl border border-white/10 bg-gradient-to-b from-[#141218] via-[#09080c] to-[#040406] shadow-2xl min-h-[220px] sm:min-h-[260px] relative overflow-hidden">
                        ...
                        <img id="live-transparent-preview" src="{{ $product->image_url }}" alt="Transparent Preview" 
...
<script>
    ...
    function generateProductDescriptionAI() {
        ...
        const angles = [
            ...
            `A poetic embodiment of grace and sophistication, the ${productName} is created for moments you never want to forget. The harmonious blend of fine ${material} and brilliant detailing creates a cherished heirloom that speaks of love, prestige, and timeless beauty.`,
