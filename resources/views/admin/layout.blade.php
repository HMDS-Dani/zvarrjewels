...
<body class="min-h-screen flex antialiased bg-[#050508] text-slate-200 selection:bg-amber-400 selection:text-black">
        ...
        <div>
            ...
            <div class="h-24 flex items-center px-6 border-b border-white/5 gap-3.5 bg-gradient-to-b from-amber-950/20 to-transparent">
                ...
                <div>
                    ...
                    <p class="text-[9px] uppercase font-bold tracking-[0.25em] gold-text-shimmer">HAUTE CRM PORTAL</p>
                </div>
            </div>

            <!-- Navigation Links -->
            <nav class="p-4 space-y-1.5">
                <div class="px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest text-stone-500">Maison Management</div>
                ...
                <div class="pt-3 px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest text-stone-500">Concierge & Clients</div>
                ...
                <a href="{{ route('admin.contacts.index') }}" 
                    ...
                    <span>Store Identity & Links</span>
                </a>
        ...
        <div class="p-4 border-t border-white/5 bg-[#07070b]">
            <div class="p-3 rounded-2xl bg-white/[0.03] border border-white/5 flex items-center justify-between">
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        <p class="text-xs font-bold text-white truncate">{{ Auth::user()->name ?? 'Store Director' }}</p>
                        <p class="text-[10px] text-amber-400 font-medium">Maison Executive</p>
                    </div>
                </div>
    ...
    <div class="flex-1 flex flex-col min-w-0 relative">
        ...
        <div id="mobile-menu-drawer" class="hidden fixed inset-0 bg-black/85 backdrop-blur-xl z-50 md:hidden transition-all duration-300" onclick="handleDrawerBackdrop(event)">
            <div class="w-80 bg-[#09090f] h-full border-r border-amber-400/20 p-6 flex flex-col justify-between shadow-2xl relative" onclick="event.stopPropagation()">
                
                <div class="space-y-6">
                    <!-- Brand Banner -->
                    <div class="flex items-center justify-between border-b border-white/10 pb-5">
                        <div class="flex items-center gap-3">
                            <div class="w-11 h-11 rounded-2xl bg-gradient-to-br from-amber-200 via-amber-400 to-amber-600 p-[1px] shadow-lg shadow-amber-500/20">
                                <div class="w-full h-full bg-[#09090d] rounded-2xl flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p class="text-[9px] uppercase tracking-widest text-amber-400 font-bold">BY ZAIYAL CRM</p>
                            </div>
                        </div>
                    ...
                    <nav class="space-y-1.5">
                        ...
                        <a href="{{ route('admin.contacts.index') }}" onclick="toggleMobileDrawer()"
                            ...
                            <span>Store Contacts & Socials</span>
                        </a>
                ...
                <div class="border-t border-white/10 pt-4 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-xs font-bold text-white">{{ Auth::user()->name ?? 'Store Director' }}</p>
                            <p class="text-[10px] text-amber-400 font-medium">Maison Executive</p>
                        </div>
                    </div>
                    <form action="{{ route('logout') }}" method="POST">
        ...
        <nav class="md:hidden fixed bottom-3 inset-x-3 bg-[#0a0a12]/95 backdrop-blur-2xl border border-amber-400/20 rounded-3xl px-3 py-2 flex items-center justify-around z-40 shadow-2xl shadow-black/80">
            <a href="{{ route('admin.dashboard') }}" 
                ...
                <span class="text-[9px] uppercase tracking-wider">Radar</span>
            </a>
            ...
            <a href="{{ route('admin.products.index') }}" 
                ...
                <span class="text-[9px] uppercase tracking-wider">Vault</span>
            </a>
            ...
            <a href="{{ route('admin.inquiries.index') }}" 
                ...
                <span class="text-[9px] uppercase tracking-wider">Inquiries</span>
            </a>
    ...
    <div id="delete-confirm-modal" class="hidden fixed inset-0 bg-black/85 backdrop-blur-md z-50 items-center justify-center p-4">
        <div class="glass-card-luxury p-6 sm:p-8 rounded-3xl max-w-md w-full shadow-2xl relative space-y-5 text-center border border-rose-500/30">
            ...
            <div class="space-y-2">
                <h3 class="text-xl font-bold text-white font-cinzel tracking-wide">Confirm Revocation</h3>
                <p class="text-xs text-stone-300 leading-relaxed">
                    Are you sure you want to remove <br>
                    <span id="delete-modal-item-name" class="font-bold text-rose-400 underline decoration-rose-500/40"></span>?
                </p>
                <p class="text-[11px] text-stone-500">This record will be permanently deleted from the vault.</p>
            </div>
